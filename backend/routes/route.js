...
router.use('/uploads', express.static(path.join(__dirname, 'uploads'))); // To serve uploaded files
...
// Student
//QR-generation
router.get('/Student/StudentQR' ,generateQRCode);
// router.post('/Student/StudentQR', generateQRCode);
